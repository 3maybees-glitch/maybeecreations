    ...
    >
      <section className="py-6 md:py-12 px-4">
        <div className="container mx-auto max-w-3xl text-center">
          <p className="text-lg md:text-2xl text-foreground/90 mb-4 md:mb-6 italic leading-relaxed font-medium">
      ...
      <section className="py-6 md:py-12 px-4">
        <div className="container mx-auto max-w-2xl">
          <div className="parchment p-6 md:p-8 rounded-sm">
            <h3 className="text-xl md:text-3xl font-bold text-primary text-center mb-4 md:mb-6">
              What's Included?
            </h3>
            <p className="text-center text-muted-foreground italic mb-4 md:mb-6">
