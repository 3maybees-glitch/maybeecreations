...
export const stories: Story[] = [
  {
    ...
    paragraphs: [
      ...
      "Our work spans five realms: Faith, Freedom, Frontier, Fans, and the Future. Soul Explorer Bible maps walk the lands of Scripture. Liberty Explorer maps chart the birth of a republic and the conflicts that shaped the modern world. Frontier Explorer maps open science, literature, music, and missionary lives — Einstein, the Odyssey, Mozart, and more. Legend Explorer Baseball Legend Lands turn ballpark loyalty into fantasy cartography. Tomorrow Explorer maps help beginners navigate the AI era with courage and clarity.",
