...
export interface FreedomMap {
  ...
  tagline: string;
  image: string;
  /** Checkout URL on Shopify (Liberty Explorer) */
  url?: string;
  price?: string;
}
...
export const freedomMaps: FreedomMap[] = [
  {
    ...
    url: "https://maybeecreation.myshopify.com/products/george-washington-history-map-guidebook-founding-father-wall-art-liberty-explorer-printable-435478237",
    price: "$7.77",
  },
  {
    ...
    url: "https://maybeecreation.myshopify.com/products/thomas-jefferson-history-map-guidebook-founding-father-wall-art-liberty-explorer-printable-435478235",
    price: "$7.77",
  },
  {
    name: "James Madison",
  ...
  },
  {
    ...
    url: "https://maybeecreation.myshopify.com/products/alexander-hamilton-history-map-guidebook-founding-father-wall-art-liberty-explorer-printable-435478200",
    price: "$7.77",
  },
  {
    ...
    url: "https://maybeecreation.myshopify.com/products/benjamin-franklin-history-map-guidebook-founding-father-wall-art-liberty-explorer-printable-435478173",
    price: "$7.77",
  },
  {
    ...
    url: "https://maybeecreation.myshopify.com/products/revolutionary-war-history-map-guidebook-military-classroom-art-liberty-explorer-printable-435478225",
    price: "$7.77",
  },
  {
    name: "Civil War",
    ...
    url: "https://maybeecreation.myshopify.com/products/american-civil-war-history-map-guidebook-military-classroom-art-liberty-explorer-printable-435478269",
    price: "$7.77",
  },
  {
    ...
    url: "https://maybeecreation.myshopify.com/products/world-war-ii-europe-history-map-guidebook-military-classroom-art-liberty-explorer-printable-435478050",
    price: "$7.77",
  },
  {
    ...
    url: "https://maybeecreation.myshopify.com/products/world-war-ii-pacific-history-map-guidebook-military-classroom-art-liberty-explorer-printable-435478262",
    price: "$7.77",
  },
  {
    name: "World War I",
    ...
    url: "https://maybeecreation.myshopify.com/products/world-war-i-history-map-guidebook-military-classroom-art-liberty-explorer-printable-435478270",
    price: "$7.77",
  },
  {
    name: "War of 1812",
    ...
    url: "https://maybeecreation.myshopify.com/products/war-of-1812-history-map-guidebook-military-classroom-art-liberty-explorer-printable-435478264",
    price: "$7.77",
  },
  {
    name: "Cold War",
    ...
    url: "https://maybeecreation.myshopify.com/products/cold-war-history-map-guidebook-military-classroom-art-liberty-explorer-printable-435478268",
    price: "$7.77",
  },
  {
    name: "Korean War",
    ...
    url: "https://maybeecreation.myshopify.com/products/korean-war-history-map-guidebook-military-classroom-art-liberty-explorer-printable-435478266",
    price: "$7.77",
  },
  {
    name: "Gulf War",
    ...
    url: "https://maybeecreation.myshopify.com/products/gulf-war-history-map-guidebook-military-classroom-art-liberty-explorer-printable-435478272",
    price: "$7.77",
  },
  {
    name: "War on Terror",
    ...
    url: "https://maybeecreation.myshopify.com/products/war-on-terror-history-map-guidebook-military-classroom-art-liberty-explorer-printable-435478267",
    price: "$7.77",
  },
  {
    name: "America 250",
    category: "American History",
    subtitle: "Liberty Explorer U.S. History 250th Anniversary Map",
    tagline:
