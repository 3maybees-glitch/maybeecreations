...
import type { FrontierMap } from "@/data/frontierMaps";

export const FrontierMapCard = ({ map }: { map: FrontierMap }) => (
  <article className="parchment rounded-sm overflow-hidden flex flex-col group transition-transform hover:-translate-y-1 duration-300">
    <div className="relative overflow-hidden bg-muted aspect-[4/3]">
      <img
        src={map.image}
        alt={`Frontier Explorer ${map.name} ${map.series} map`}
        loading="lazy"
