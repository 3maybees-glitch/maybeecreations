        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/refund" className="text-lg text-muted-foreground hover:text-accent transition-colors">
                  Refund Policy
                </Link>
              </li>
              <li>
                <Link to="/shipping" className="text-lg text-muted-foreground hover:text-accent transition-colors">
                  Shipping Policy
                </Link>
              </li>
              <li>
