...
const entries: SitemapEntry[] = [
  ...
  { path: "/snackers", changefreq: "monthly", priority: "0.8" },
  { path: "/jesus-wept", changefreq: "monthly", priority: "0.8" },
  { path: "/jesus-wept/support", changefreq: "monthly", priority: "0.7" },
  { path: "/intellicity", changefreq: "monthly", priority: "0.8" },
